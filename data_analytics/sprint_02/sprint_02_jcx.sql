...
-- Creem les taules company (com a l'arxiu estructura_dades.sql)
...
-- Creem les taules credit_card i user (amb les claus primàries necessàries)
...
-- Creem la taula transaction (semblant a l'arxiu estructura_dades.sql)
...
-- Insertem les dades de transactions i company (dades_introduir_sprint2.sql)
